...
function App(props) {
  ...
  return (
    ...
    <Compnaies company_name ="Zain" employee_member="1000" yearOfEstablis="2000" name1 = "ahmad" name2="mohammed" name3="amal" typefServices="programming" prices="1000$" companyName1= "Zain"></Compnaies>
    <Compnaies company_name ="Aramco" employee_member="2000" yearOfEstablis="1999" name1 = "amjad" name2="Sarah" name3="Turki" typefServices="Oil Gas" prices="2200$" companyName1= "Aramco"></Compnaies>
    <Compnaies company_name ="Tuwaiq" employee_member="2000" yearOfEstablis="2002" name1 = "amjad" name2="Sarah" name3="Turki" typefServices="Teaching" prices="2200$" companyName1= "Tuwaiq"></Compnaies>
